package com.huahua.recruit.service;

import com.huahua.recruit.common.StaticParams;
import com.huahua.recruit.dao.RecruitDao;
...
public class RecruitService {
    ...
    public List<Recruit> findAllByState(){
	 return recruitDao.findTop4AllByState(StaticParams.RECOMMEND_STATE);
	}

	public List<Recruit> queryByStateNewRecruitList(){
        return recruitDao.queryByStateNewRecruitList(StaticParams.RECOMMEND_STATE_NOT_STOP);
    }
}
