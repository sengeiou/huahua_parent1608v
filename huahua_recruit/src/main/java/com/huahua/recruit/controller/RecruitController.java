...
public class RecruitController {
	...
	public Result findAllByState(){
		return new Result(true,StatusCode.OK,"查询成功",recruitService.findAllByState());
	...
	public Result queryByStateNewRecruitList(){
		return new Result(true,StatusCode.OK,"查询成功",recruitService.queryByStateNewRecruitList());
