...
public Result hotlist(@PathVariable String labelid,@PathVariable Integer page
		,@PathVariable Integer size){
	...
	public Result waitlist(@PathVariable String labelid,@PathVariable Integer page
			,@PathVariable Integer size){
	...
	public Result queryById(@PathVariable("labelId") String labelId){
		return 	labelEureka.queryById(labelId);
	}
