...
public class ReplyController {
	...
	public Result findAllByProblemidOrderByCreatetimeDesc(@PathVariable String  id){
		List<Reply> replyList = replyService.findAllByProblemidOrderByCreatetimeDesc(id);
		return new Result(true,StatusCode.OK,"查询成功",replyList);
	}
